namespace SpriteKind {
    export const Instructer = SpriteKind.create()
}
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    mySprite2 = sprites.create(img`
        ...
        . . . . . f f . . f f . . . . . 
        `, SpriteKind.Player)
    game.showLongText("Nice you got your helmet already good start", DialogLayout.Bottom)
})
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
game.showLongText("I’m going to teach you how to ride a motobike", DialogLayout.Bottom)
